...
def name_conversion_par(name_data):
    ...
    for name in name_data:
        ...
        name = name.replace('Turn right', 'TrnRt')
        name = name.replace('Turn left', 'TrnLft')
        name = name.replace('Turn slight right', 'TrnSltRt')
        name = name.replace('Turn slight left', 'TrnSltLft')
        name = name.replace('Keep right', 'KpRt')
        name = name.replace('Keep left', 'KpLft')
...
def convert_input_units(decoded_data, source):
    ...
    converted_data = {"latitude": latitude_data_converted,
